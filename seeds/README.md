...
> personas reales de FISEI. Cada integrante del equipo crea estos
> seeds en su propio entorno local antes de empezar a trabajar.

## 📁 Archivos

- **`users.json`** — admin + 5 cuentas estudiante de prueba
- **`courses.json`** — 1 curso de prueba con formato Tiles y 5 actividades
...
2. **Create new category**:
   - **Category name**: `(SOF) Ingeniería en Software - DEMO`
   - **Category ID number**: `SOF-DEMO`
3. **Create category**
...
2. Llenar:
   - **Course full name**: `(SOF) Algoritmos y Lógica de Programación - DEMO`
   - **Course short name**: `ALG-DEMO`
   - **Course category**: `(SOF) Ingeniería en Software - DEMO`
...
- ¿Ve el curso `ALG-DEMO` en Mi dashboard?
...
- ✅ **NO commitear** datos reales (nombres/emails de FISEI verdaderos)
